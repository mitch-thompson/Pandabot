...
func TestOptimalCureLevelCalculation(t *testing.T) {
	...
	for i := 0; i < 100; i++ {
		t.Run("PropertyTest_OptimalCureLevelCalculation", func(t *testing.T) {
			...
			option, err := selector.SelectOptimalCure(entity, availableMP, jobLevel, prioritizeEfficiency)
...
func TestCureOptionOptimization(t *testing.T) {
	for i := 0; i < 100; i++ {
		t.Run("PropertyTest_CureOptionOptimization", func(t *testing.T) {
			...
			efficiencyOption, _ := selector.SelectOptimalCure(entity, availableMP, jobLevel, true)
			speedOption, _ := selector.SelectOptimalCure(entity, availableMP, jobLevel, false)
...
func TestMPValidationBeforeCasting(t *testing.T) {
	for i := 0; i < 100; i++ {
		t.Run("PropertyTest_MPValidationBeforeCasting", func(t *testing.T) {
			...
			option, err := selector.SelectOptimalCure(entity, availableMP, jobLevel, true)
...
func TestInvalidInputHandling(t *testing.T) {
	...
	// Test nil entity
	_, err := selector.SelectOptimalCure(nil, 100, map[string]int{"WHM": 50}, true)
	if err == nil {
	...
	_, err = selector.SelectOptimalCure(fullHealthEntity, 100, map[string]int{"WHM": 50}, true)
	if err == nil {
